...
fit_1_dom0 <- lm(y_train ~ poly(train_idx, degree=6))
fit_1_dom <- lm(y_train ~ poly(train_idx, degree=6) + poly(train_gov_lag))
fit_1_dom_pred0 <- lm(y_total ~ poly(total_idx, degree=6))
fit_1_dom_pred <- lm(y_total ~ poly(total_idx, degree=6) + poly(total_gov_lag))
summary(fit_1_dom0); summary(fit_1_dom_pred0)
summary(fit_1_dom); summary(fit_1_dom_pred)

predict_1_dom0 <- predict(fit_1_dom0, data.frame(train_idx=test_idx))
predict_1_dom_pred0 <- predict(fit_1_dom_pred0, data.frame(total_idx=pred_idx))
...
p2_1_dom0 <- ggplot() +
  ...
  geom_line(aes(train_idx, fitted(fit_1_dom0)), color=2, alpha=1) +
  
  geom_line(aes(train_idx, train_gov*1000), color=4) +
  scale_y_continuous(limits=c(0, 3000), sec.axis = sec_axis(~./1000, name="사회적 거리두기 (단계)"))+
  
  geom_point(aes(test_idx, y_test), alpha=0.5) +
  geom_line(aes(test_idx, predict_1_dom0), color=2, size=1, linetype=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자", ylim=3000,
       subtitle="Polynomial Regression (Degree = 6)"); p2_1_dom0
training_rmse_1_dom0 <- rmse(y_train, fitted(fit_1_dom0)); training_rmse_1_dom0
testing_rmse_1_dom0 <- rmse(y_test, predict_1_dom0); testing_rmse_1_dom0
...
p2_1_dom <- ggplot() +
  ...
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Polynomial Regression (Degree = 6) / Lag for Government Index = 12"); p2_1_dom
...
# predict
p2_1_dom_pred0 <- ggplot() +
  geom_point(aes(total_idx, y_total), alpha=0.5) +
  geom_line(aes(total_idx, fitted(fit_1_dom_pred0)), color=2) +
  
  geom_line(aes(train_idx, train_gov*1000), color=4) +
  scale_y_continuous(limits=c(0, 3000), sec.axis = sec_axis(~./1000, name="사회적 거리두기 (단계)"))+
  
  geom_line(aes(pred_idx, predict_1_dom_pred0), color=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Polynomial Regression (Degree = 6)"); p2_1_dom_pred0
...
p2_1_dom_pred <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Polynomial Regression (Degree = 6) / Lag for Government Index = 12"); p2_1_dom_pred
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
...
fit_2_dom0 <- lm(y_train ~ bs(train_idx, knots=c(15, 190, 267)))
fit_2_dom_pred0 <- lm(y_total ~ bs(total_idx,  knots=c(15, 190, 267)))
...
summary(fit_2_dom0); summary(fit_2_dom_pred0)
summary(fit_2_dom); summary(fit_2_dom_pred)

predict_2_dom0 <- predict(fit_2_dom0, data.frame(train_idx=test_idx))
predict_2_dom_pred0 <- predict(fit_2_dom_pred0, data.frame(total_idx=pred_idx))
...
p2_2_dom0 <- ggplot() +
  geom_point(aes(train_idx, y_train), alpha=0.5) +
  geom_line(aes(train_idx, fitted(fit_2_dom0)), color=2, alpha=0.5) +
  
  geom_point(aes(test_idx, y_test), alpha=0.5) +
  geom_line(aes(test_idx, predict_2_dom0), color=2, size=1, linetype=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Cubic Spline (Knots = 15, 190, 267)"); p2_2_dom0
training_rmse_2_dom0 <- rmse(y_train, fitted(fit_2_dom0)); training_rmse_2_dom0
testing_rmse_2_dom0 <- rmse(y_test, predict_2_dom0); testing_rmse_2_dom0
...
p2_2_dom <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Cubic Spline (Knots = 15, 190, 267) / Lag for Government Index = 12"); p2_2_dom
...
# predict
p2_2_dom_pred0 <- ggplot() +
  geom_point(aes(total_idx, y_total), alpha=0.5) +
  geom_line(aes(total_idx, fitted(fit_2_dom_pred0)), color=2, alpha=0.5) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Cubic Spline (Knots = 15, 190, 267)"); p2_2_dom_pred0
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
predict_2_dom_pred0
...
p2_2_dom_pred <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Cubic Spline (Knots = 15, 190, 267) / Lag for Government Index = 12"); p2_2_dom_pred
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
...
fit_4_dom0 <- locfit(y_train ~ train_idx, alpha=0.2)
fit_4_dom_pred0 <- locfit(y_total ~ total_idx, alpha=0.2)
...
summary(fit_4_dom0); summary(fit_4_dom_pred0)
summary(fit_4_dom); summary(fit_4_dom_pred)

predict_4_dom0 <- predict(fit_4_dom0, data.frame(train_idx=test_idx))
predict_4_dom_pred0 <- predict(fit_4_dom_pred0, data.frame(total_idx=pred_idx))
...
p2_4_dom0 <- ggplot() +
  geom_point(aes(train_idx, y_train), alpha=0.5) +
  geom_line(aes(train_idx, fitted(fit_4_dom0)), color=2) +
  
  geom_point(aes(test_idx, y_test), alpha=0.5) +
  geom_line(aes(test_idx, predict_4_dom0), color=2, size=1, linetype=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Local Regression (alpha = 0.2)"); p2_4_dom0
training_rmse_4_dom0 <- rmse(y_train, fitted(fit_4_dom0)); training_rmse_4_dom0
testing_rmse_4_dom0 <- rmse(y_test, predict_4_dom0); testing_rmse_4_dom0
...
p2_4_dom <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Local Regression (alpha = 0.2) / Lag for Government Index = 12"); p2_4_dom
...
p2_4_dom_pred0 <- ggplot() +
  geom_point(aes(total_idx, y_total), alpha=0.5) +
  geom_line(aes(total_idx, fitted(fit_4_dom_pred0)), color=2) +
  
  geom_line(aes(train_idx, train_gov*1000), color=4) +
  scale_y_continuous(limits=c(0, 3000), sec.axis = sec_axis(~./1000, name="사회적 거리두기 (단계)"))+
  
  geom_line(aes(pred_idx, predict_4_dom_pred0), color=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Local Regression (alpha = 0.2)"); p2_4_dom_pred0
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
predict_4_dom_pred0
...
p2_4_dom_pred <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Local Regression (alpha = 0.2)) / Lag for Government Index = 12"); p2_4_dom_pred
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
...
fit_5_dom0 <- gam(y_train ~ s(train_idx), method="REML")
fit_5_dom_pred0 <- gam(y_total ~ s(total_idx), method="REML")
...
summary(fit_5_dom0); summary(fit_5_dom_pred0)
summary(fit_5_dom); summary(fit_5_dom_pred)

predict_5_dom0 <- predict(fit_5_dom0, data.frame(train_idx=test_idx))
predict_5_dom_pred0 <- predict(fit_5_dom_pred0, data.frame(total_idx=pred_idx))
...
p2_5_dom0 <- ggplot() +
  geom_point(aes(train_idx, y_train), alpha=0.5) +
  geom_line(aes(train_idx, fitted(fit_5_dom0)), color=2) +
  
  geom_point(aes(test_idx, y_test), alpha=0.5) +
  geom_line(aes(test_idx, predict_5_dom0), color=2, size=1, linetype=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="GAM (method = `RELM`)"); p2_5_dom0
training_rmse_5_dom0 <- rmse(y_train, fitted(fit_5_dom0)); training_rmse_5_dom0
testing_rmse_5_dom0 <- rmse(y_test, predict_5_dom0); testing_rmse_5_dom0
...
p2_5_dom <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="GAM (method = `RELM`) / Lag for Government Index = 12"); p2_5_dom
...
# predict
p2_5_dom_pred0 <- ggplot() +
  geom_point(aes(total_idx, y_total), alpha=0.5) +
  geom_line(aes(total_idx, fitted(fit_5_dom_pred0)), color=2) +
  
  geom_line(aes(train_idx, train_gov*1000), color=4) +
  scale_y_continuous(limits=c(0, 3000), sec.axis = sec_axis(~./1000, name="사회적 거리두기 (단계)"))+
  
  geom_line(aes(pred_idx, predict_5_dom_pred0), color=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="GAM (method = `RELM`)"); p2_5_dom_pred0
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
predict_5_dom_pred0
...
p2_5_dom_pred <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="GAM (method = `RELM`) / Lag for Government Index = 12"); p2_5_dom_pred
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
...
fit_6_dom0 <- glm(y_train ~ log(train_idx) + train_idx, family=poisson)
fit_6_dom_pred0 <- glm(y_total ~ log(total_idx) + total_gov_lag, family=poisson)
...
summary(fit_6_dom0); summary(fit_6_dom_pred0)
...
fit_6_dom01 <- glm(y1 ~ log(train_idx1) + train_idx1, family=poisson)
fit_6_dom02 <- glm(y2 ~ log(train_idx2) + train_idx2, family=poisson)
fit_6_dom03 <- glm(y3 ~ log(train_idx3) + train_idx3, family=poisson)
...
fit_6_dom_pred01 <- glm(y_total1 ~ log(total_idx1) + total_idx1, family=poisson)
fit_6_dom_pred02 <- glm(y_total2 ~ log(total_idx2) + total_idx2, family=poisson)
fit_6_dom_pred03 <- glm(y_total3 ~ log(total_idx3) + total_idx3, family=poisson)
...
predict_6_dom0 <- exp(predict(fit_6_dom03, data.frame(train_idx3=test_idx)))
predict_6_dom_pred0 <- exp(predict(fit_6_dom_pred03, data.frame(total_idx3=pred_idx)))
...
p2_6_dom0 <- ggplot() +
  geom_point(aes(train_idx, y_train), alpha=0.5) +
  geom_line(aes(train_idx1, fitted(fit_6_dom01)), color=2) +
  geom_line(aes(train_idx2, fitted(fit_6_dom02)), color=2) +
  geom_line(aes(train_idx3, fitted(fit_6_dom03)), color=2) +
  
  geom_point(aes(test_idx, y_test), alpha=0.5) +
  geom_line(aes(test_idx, predict_6_dom0), color=2, size=1, linetype=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Segmented Poisson (Breakpoint = 15, 190, 267)"); p2_6_dom0
training_rmse_6_dom0 <- rmse(y_train, fitted(fit_6_dom0)); training_rmse_6_dom0
testing_rmse_6_dom0 <- rmse(y_test, predict_6_dom0); testing_rmse_6_dom0
...
p2_6_dom <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Segmented Poisson (Breakpoint = 15, 190, 267) / Lag for Government Index = 12"); p2_6_dom
...
p2_6_dom_pred0 <- ggplot() +
  geom_point(aes(total_idx, y_total), alpha=0.5) +
  geom_line(aes(total_idx1, fitted(fit_6_dom_pred01)), color=2) +
  geom_line(aes(total_idx2, fitted(fit_6_dom_pred02)), color=2) +
  geom_line(aes(total_idx3, fitted(fit_6_dom_pred03)), color=2) +
  
  geom_line(aes(train_idx, train_gov*1000), color=4) +
  scale_y_continuous(limits=c(0, 3000), sec.axis = sec_axis(~./1000, name="사회적 거리두기 (단계)"))+
  
  geom_line(aes(pred_idx, predict_6_dom_pred0), color=3) +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Segmented Poisson (Breakpoint = 15, 190, 267)"); p2_6_dom_pred0
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
predict_6_dom_pred0
...
p2_6_dom_pred <- ggplot() +
  ...
  theme_classic(base_family="NanumGothic") +
  labs(x="날짜 (월)", y="일일 확진자", title="COVID-19 전국 신규 확진자",
       subtitle="Segmented Poisson (Breakpoint = 15, 190, 267) / Lag for Government Index = 12"); p2_6_dom_pred
# 향후 20일간 (12/18일 이후) 일일 확진자 예측값
