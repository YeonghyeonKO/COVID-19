...
derivative_analysis(Country = "Canada",gkf_bandwidth = 14,first_break = 50,save_image = FALSE,save_excel = FALSE)
...
for(i in country){
  tryCatch(
    expr={
      ...
      coef_temp = segLogistic_separate(Country=i,break_point = break_point,save_image = FALSE,prediction_plot = FALSE,
                                       max_iter = 1000)
