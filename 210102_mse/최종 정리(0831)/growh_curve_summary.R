...
df <- read.csv("/Users/yeonghyeon/Documents/GitHub/COVID-19/210102_mse/최종 정리(0831)/COVID-19-geographic-disbtribution-worldwide.csv")
...
country = c("Aruba", "Benin", "Cameroon", "Croatia", "Djibouti", "Equatorial_Guinea", "Guinea_Bissau", "Iceland",
            "Kenya", "Kyrgyzstan", "Lithuania", "Malaysia", "Malta", "Niger", "Rwanda", "South_Korea", "South_Sudan",
            "Thailand", "Western_sahara")
for(i in country){
  tryCatch(
    expr={
      temp = which(rownames(break_sum)==i)
      break_point = df_result$first_day[temp]
      for(j in 2:5){
