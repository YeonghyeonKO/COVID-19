...
result_path <- paste0(path, "regression result_log/")
plot_path <- paste0(path, "regression result_log/plot/")
...
write.csv(df_sum, paste0(result_path, "log_regression_ourworld.csv"), row.names = F)
