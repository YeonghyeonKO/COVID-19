...
# Segmentation
df_result = segmentation(Country = country,gkf_bandwidth = 14,first_day_criteria = 50,save_image = TRUE,save_excel = TRUE)
...
country = as.character(df_result$country)[113:130]
...
# Excluded Countries : Aruba / Equatorial_Guinea / Kyrgyzstan / Rwanda / Thailand
...
# Excluded Countries : China / Equatorial_Guinea / Kyrgyzstan / Rwanda / Zambia
