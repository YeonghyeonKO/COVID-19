...
segLogistic = function(Country,start_date=1,
                       ...
                       daily_plot = FALSE){
  if(save_image){png(filename=paste0("cumulative/",i,".png"))}
  ...
  if(prediction_plot){
    plot(x,y,xlab=paste("Days since",as.Date(t,origin = "2019-12-31")),
         ylab="Daily cases",main=Country,xlim=c(0,n+30),ylim=c(0,2*max(y))) 
  }else{
    plot(x,y,xlab=paste("Days since",as.Date(t,origin = "2019-12-31")),
         ylab="Daily cases",main=Country) 
  }
...
segLogistic_daily = function(Country,start_date=1,
                       ...
                       save_image = FALSE,
                       prediction_plot = FALSE){
  if(save_image){png(filename=paste0("daily/",i,".png"))}
  ...
  if(prediction_plot){
    plot(x,y_day,xlab=paste("Days since",as.Date(t,origin = "2019-12-31")),
         ylab="Daily cases",main=Country,xlim=c(0,n+30),ylim=c(0,2*max(y_day))) 
  }else{
    plot(x,y_day,xlab=paste("Days since",as.Date(t,origin = "2019-12-31")),
         ylab="Daily cases",main=Country) 
  }
...
segLogistic_separate = function(Country,start_date=1,
                       ...
                       prediction_plot = FALSE,
                       daily_plot = FALSE){
  if(save_image){png(filename=paste0("separate/",i,".png"))}
